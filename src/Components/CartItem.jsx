...
function CartItem({id,name,size,type,totalPrice,totalCount,onRemoveItem,onMinus,onPlus}) {
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-remove">
              <button onClick = {OnRemoveCartItem} className="button button--outline button--circle">
                <svg
                  width="10"
                  height="10"
                  viewBox="0 0 10 10"
